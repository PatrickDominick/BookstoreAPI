...
mutliple_book_schema = BookSchema(many=True)
...
def get_books():
    ...
    # print(records)
    # records_dictionaries = []
    # for book in records :
    #     book_dictionary = {}
    #     book_dictionary["id"] = book.id
    #     book_dictionary["title"] = book.title
    #     book_dictionary["author"] = book.author
    #     book_dictionary["review"] = book.review
    #     records_dictionaries.append(book_dictionary)
    return jsonify(mutliple_book_schema.dump(records))
...
def get_books_by_author(author):
    record = db.session.query(Book).filter(Book.author == author).all()
    return jsonify(mutliple_book_schema.dump(records))
